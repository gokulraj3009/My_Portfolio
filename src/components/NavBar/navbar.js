    ...
    return (
        <nav className="navbar">
            ...
            <div className="desktopMenu">
                ...
                <Link activeClass='active' to='hobby' spy={true} smooth={true} offset={-50} duration={500} className="desktopMenuListItem">Hobby</Link>
            </div>
            ...
            <div className="navMenu" style={{display: showMenu? 'flex':'none'}}>
                ...
                <Link activeClass='active' to='works' spy={true} smooth={true} offset={-50} duration={500} className="listItem" onClick={()=>setShowMenu(false)}>My Works</Link>
                ...
                <Link activeClass='active' to='hobby' spy={true} smooth={true} offset={-50} duration={500} className="listItem" onClick={()=>setShowMenu(false)}>Hobby</Link>
